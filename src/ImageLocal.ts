...
export class ImageLocal implements ImageOp {
  ...
  public constructor(p: CanvasRenderingContext2D, ready?: boolean){
    ...
    this.dibujarCanvas = this.dibujarCanvas.bind(this);
  }
  ...
  public dibujarCanvas(evt:any): void{
    let canvas:CanvasRenderingContext2D;
    let aux: number;
    canvas=this.screen;

    console.log('Funcion dibujarCanvas');
    if(this.x1==null){
      this.x1 = evt.offsetX;
      this.y1 =evt.offsetY;
      ...
      if(this.x2==null){
        ...
        if(this.x3==null){
          ...
          if(this.x4==null){
            ...
            this.matrizBilinial= [[this.x1+2,this.x2-2,this.x3-2,this.x4+2],
            [this.y1+2,this.y2+2,this.y3-2,this.y4-2]];
            console.log(this.matrizBilinial);
